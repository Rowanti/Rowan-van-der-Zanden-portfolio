...
label.pack()
noBalanceFrameDesign = tk.PhotoImage(file='Frames/Resized/noBalance-screen.png')
pinFrameDesign = tk.PhotoImage(file='Frames/Resized/pin-invoer.png')
incorrectPinFrameDesign = tk.PhotoImage(file='Frames/Resized/wrong-pin-reworked.png')
...
confirmFrameDesign = tk.PhotoImage(file='Frames/Resized/confirmation-screen.png')
...
def confirmAmount():
    ...
    withdrawAmount.set(str(withdrawAmount.get()).replace(" ", ""))
    aButton.configure(command="none")
    bButton.configure(command="none")
